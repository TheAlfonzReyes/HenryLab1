...
# from pyngrok import ngrok #Para correrlo en Google Colab

app = FastAPI(title="Alfonso Henry Labs 1 API ML-OPS")
...
def recomendacion_usuario(usuario:str):
    ...
    df = pd.read_json('ETL-EDA/EDA/EDA_Dataset.json.gz', compression='gzip', encoding='MacRoman') 
    ...
    # EN LINUX (DEPLOY) NO USAMOS LA R, Solamente se usa en Windows o prueba local.
